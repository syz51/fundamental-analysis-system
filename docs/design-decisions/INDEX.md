...
| DD-012 | [Workflow Pause/Resume Infrastructure](DD-012_WORKFLOW_PAUSE_RESUME.md)           | Approved    | 2025-11-18 | Architecture, Operations             | [Analysis Pipeline](../operations/01-analysis-pipeline.md), [Agents Coordination](../architecture/05-agents-coordination.md), [Memory System](../architecture/02-memory-system.md), [Flaw #23](../design-flaws/resolved/23-workflow-pause-resume.md), Enables [#19](../design-flaws/active/19-partial-failures.md) [#24](../design-flaws/active/24-agent-failure-alerts.md) [#25](../design-flaws/active/25-working-memory-durability.md) [#26](../design-flaws/resolved/26-multi-stock-batching.md) |
